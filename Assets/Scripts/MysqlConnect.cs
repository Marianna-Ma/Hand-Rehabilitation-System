...
public class MySqlAccess
{
    ...
    public MySqlAccess(string _host, string _port, string _id, string _pwd, string _dataBase)
    {
        host = _host;
        port = _port;
        id = _id;
    ...
    public void OpenSql()
    {
        try
        {
            ...
            string mySqlString = string.Format("Database={0};Data Source={1};User Id={2};Password={3};Port={4}", dataBase, host, id, pwd, port);
    ...
    public DataSet SimpleSql(string sqlString)
    {
